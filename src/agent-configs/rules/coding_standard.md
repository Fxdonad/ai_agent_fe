...
- **Xác thực thư mục (Strict Scope)**: 
    - Luôn đảm bảo đang đứng tại: `/home/fxdonad/Fxdonad/Agent/App`.
    - **Cấm** thao tác ngoài phạm vi `/home/fxdonad/` trừ khi được yêu cầu cài đặt package hệ thống (`apt`).
...
- **Định danh người dùng**: Không dùng biến môi trường `$USER`. Khi cần sửa quyền, hãy ghi rõ: `sudo chown -R fxdonad:fxdonad <path>`.
