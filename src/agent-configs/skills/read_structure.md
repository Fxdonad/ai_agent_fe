...
- **Root Directory (VM Base):** {{AGENT_WORK_DIR}}
...
- **Giá trị mặc định:** `"."` (Ánh xạ trực tiếp tới {{AGENT_WORK_DIR}}).
...
2. **Kiểm tra quyền hạn:** Nếu không thấy file hoặc folder mặc dù đã chạy lệnh tạo, hãy kiểm tra xem bạn có đang thực thi lệnh ở ngoài phạm vi {{WORK_SPACE_DIR}} hay không.
3. **Thứ tự thực hiện:**
